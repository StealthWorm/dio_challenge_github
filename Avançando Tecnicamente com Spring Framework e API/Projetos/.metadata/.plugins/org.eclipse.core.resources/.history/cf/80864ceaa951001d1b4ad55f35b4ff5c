...
public class TestIntController {
	...
	public void testInt() throws Exception {
		// simula a aplicação indo ate o servidor fazendo uma requisição, ccriando um Mock
		RequestBuilder requisicao = get("/test");
		MvcResult resultado = mvc.perform(requisicao).andReturn(); //para retornar a requisição
