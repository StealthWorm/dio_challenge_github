...
public class SwaggerConfig {
    ...
    public Docket detalheApi() {
        ...
        docket
                .select()
                .apis(RequestHandlerSelectors.basePackage("dio.web.api.controller"))  //Para que o Swagger não precise escanear toda a aplicação, definimos o caminho do pacote de Controllers no ".apis()"
