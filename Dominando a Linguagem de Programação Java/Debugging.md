...
## Stack Trace:
  ...
  *Thread.dumpStack();*
  *printStackTrace* : função aplicada na chave do "catch" para mostrar a stack de execuçao
  - voce começa a ler de baixo para cima no terminal
...
<ul>
    ...
    <li>NumberFormatException - define erro no tipo do dado de entrada</li>
    <li>ArithmeticException - define erroem operações Aritméticas</li>
    <li>IOException - lançado ao acessar informações usando fluxos, arquivos e diretórios.</li>
</ul>
